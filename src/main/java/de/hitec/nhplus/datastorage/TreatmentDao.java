...
public class TreatmentDao extends DaoImp<Treatment> {
	...
	protected PreparedStatement getCreateStatement(Treatment treatment) {
		...
		try {
			final String SQL = "INSERT INTO treatment (pid, treatment_date, begin, end, description, remark, nurseSurname, nurseFirstname, nursePhonenumber, nurseLocked, IS_LOCKED) " +
				"VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			...
			preparedStatement.setString(10, treatment.getNurseLocked());
	...
	protected Treatment getInstanceFromResultSet(ResultSet result) throws SQLException {
		...
		return new Treatment(result.getLong(1), result.getLong(2),
			date, begin, end, result.getString(6), result.getString(7), result.getString(8), result.getString(9), result.getString(10), result.getString(11), result.getString(12));
	}
	...
	protected PreparedStatement getUpdateStatement(Treatment treatment) {
		...
		try {
			...
			preparedStatement.setString(11, treatment.getNurseLocked());
