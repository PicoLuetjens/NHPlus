...
public class SetUpDB {
	...
	private static void setUpTableTreatment(Connection connection) {
		final String SQL = "CREATE TABLE IF NOT EXISTS treatment (" +
			...
			"   nurseLocked TEXT NOT NULL," +
			"   IS_LOCKED TEXT NOT NULL," +
			"   FOREIGN KEY (pid) REFERENCES patient (pid) ON DELETE CASCADE, " +
			" FOREIGN KEY (nurseLocked) REFERENCES nurse (IS_LOCKED) ON DELETE CASCADE " +
			");";
	...
	private static void setUpTreatments() {
		try {
			...
			dao.create(new Treatment(12,
				...
				"false",
				"false"));
			dao.create(new Treatment(14, 4, convertStringToLocalDate("2023-08-24"), convertStringToLocalTime("09:30"), convertStringToLocalTime("10:15"), "KG", "Lympfdrainage", "Wagner", "Klaus", "0421 8765432", "false", "false"));
